...
//         if (strExists(uniqueUstensiles, el)) {
...
//             cleanDOM();
//             displayData(recipeMatchArray)
//             console.log(el,'exist in unique INDREDIENT in recipe', e )
//         }
//     })



//     arrayFromInputSearch.map(element => {
...
//         if (strExists(uniqueUstensiles, element)) {
...
//                 newRecipeArrayIngredients[y].ingredients.map(element => {
...
//         //         newRecipeArrayUstensiles[j].ustensils.map(element => {
...
//         //         newRecipeArrayAppliances[j].appliance.map(element => {
